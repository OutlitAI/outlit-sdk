...
<Tip>
  See [Device Tracking](/tracking/identity/anonymous-visitors#device-tracking-non-browser) for implementation details.
</Tip>
...
<Tabs>
  ...
  <Tab title="Server Tracking">
    **Identity required**
    ...
    - For device/app tracking, use `fingerprint` ([learn more](/tracking/identity/anonymous-visitors#device-tracking-non-browser))
