...
<Warning>
  Outlit uses cookies to track visitors across pages. If you need GDPR compliance, show a cookie consent banner before loading the tracker. [See consent management →](/tracking/browser/script#consent-management)
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Browser SDKs" icon="browser" href="/tracking/browser/script">
    Deep dive into browser integration
  </Card>
