...
export class OnboardingComponent {
  ...
  handleComplete(): void {
    this.outlit.track('onboarding_completed', {
      flow: 'onboarding',
      step: 'completed'
    })
...
<Info>
  Outlit Core derives activation from your selected ordinary event and derives engagement and inactivity from product activity. Billing comes from verified integrations such as Stripe. See [Customer Journey](/concepts/customer-journey).
</Info>
