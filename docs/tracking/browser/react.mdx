...
<Info>
  Configure this event as your activation signal. Outlit Core derives lifecycle stages from ordinary events, and billing status comes from verified integrations such as Stripe. See [Customer Journey](/concepts/customer-journey).
</Info>
