...
<Info>
  Configure this exact ordinary event as your activation event. Outlit Core applies its first match to eligible contacts and their resolved company; billing comes from verified integrations such as Stripe. See [Customer Journey](/concepts/customer-journey).
</Info>
