...
configuration or materializing activation. Use `outlit activation set` only after review.
Disabling future evaluation preserves existing activation timestamps and milestones.
