...
description: "How Outlit tracks contact engagement and account billing as two independent dimensions"
---
...
**Let automatic detection work.** Don't over-instrument. Outlit handles most stage transitions automatically—Discovered and Signed Up are determined by identifiers, engagement and inactivity are calculated from activity, and Stripe handles billing status.
