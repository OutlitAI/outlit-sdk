...
| [`integrations setup`](/cli/integrations#integrations-setup) | Start browser handoff or open the human-controlled setup page |
| [`integrations status`](/cli/integrations#integrations-status) | Show canonical integration readiness |
