...
| [`integrations setup`](/cli/integrations#integrations-setup) | Run browser/Nango or direct-credential provider setup |
| [`integrations add`](/cli/integrations#integrations-add) | Legacy direct-connect command |
