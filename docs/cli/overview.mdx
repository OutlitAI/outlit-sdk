...
<Steps>
  ...
  <Step title="Query your data">
    ...
    outlit customers get acme.com --include users,revenue,activity
...
| [`customers features`](/cli/commands#customers-features) | Read exact Feature usage for one authorized customer |
