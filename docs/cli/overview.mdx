...
| Command | Description |
|---------|-------------|
| [`activation`](/cli/commands#activation) | Read, historically preview, update, or disable the exact product event used for contact and company activation |
...
| [`customers features`](/cli/commands#customers-features) | Read event-based and imported metered Feature usage for one authorized customer |
| [`customers credits`](/cli/commands#customers-credits) | Read imported credit pools and burn summaries for one authorized customer |
| [`customers timeline`](/cli/commands#customers-timeline) | View activity timeline filtered by channel and event type |
| [`features`](/cli/commands#features) | Read, create, and archive workspace Features |
...
| [`integrations setup`](/cli/integrations#integration-setup) | Negotiate and complete bounded provider setup |
| [`integrations status`](/cli/integrations#integration-status) | Show canonical configuration readiness |
...
<CardGroup cols={3}>
  ...
  <Card title="Platform Configuration" icon="sliders" href="/ai-integrations/platform-actions">
    Manage destinations and selected workspace settings through API and CLI
  </Card>
