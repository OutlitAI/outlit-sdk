...
`outlit ws-users list` requires `workspace_members:read`; assign owner, grant access, update
access, and revoke access require `customer_access:manage`. The complete discover-then-mutate
...
```bash
outlit customers update-access \
  10000000-0000-4000-8000-000000000000 \
  --target-user-id user_123 \
  --role EDITOR \
  --json
...
```bash
outlit customers revoke-access \
  10000000-0000-4000-8000-000000000000 \
  --target-user-id user_123 \
  --json
```
