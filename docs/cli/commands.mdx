...
| `--mrr-above` | number | — | Filter by MRR >= amount (in cents, e.g. `10000` = $100/mo) |
| `--mrr-below` | number | — | Filter by MRR <= amount (in cents) |
...
```
20 of 150 — use --cursor cursor_abc123 for next page
```
