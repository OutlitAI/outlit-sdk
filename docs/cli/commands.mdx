...
URLs, quotes, internal responsibility-agent configuration, or billing-recovery details. The
commands are read-only: there is no resolve, reopen, send, or review operation.
