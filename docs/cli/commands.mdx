...
| `--channels` | string | — | Comma-separated channels: `PRODUCT`, `COMMUNICATION`, `MEETING`, `CRM`, `BILLING`, `SUPPORT`, `IDENTITY`, `DOCUMENT`, `SYSTEM` |
...
# Last 90 days of communication and meetings
