...
[Platform Actions](/ai-integrations/platform-actions) expose selected agent and automation configuration through REST routes that are also available from the CLI and MCP.
...
<Card title="/api/agents and /api/automations" icon="sliders" href="/ai-integrations/platform-actions">
