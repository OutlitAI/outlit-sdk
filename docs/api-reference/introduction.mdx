...
<Card title="/api/destinations and /api/settings" icon="sliders" href="/ai-integrations/platform-actions">
  Manage masked destinations and selected workspace settings
</Card>
