...
[Platform Actions](/ai-integrations/platform-actions) expose selected agent, automation, signal, destination, workspace setting, and identity merge suggestion configuration through REST routes that are also available from the CLI and MCP.
...
<Card title="/api/agents, /api/automations, /api/signals, /api/destinations, /api/settings, and /api/identity" icon="sliders" href="/ai-integrations/platform-actions">
