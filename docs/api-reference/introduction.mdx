...
The Ingest API supports CORS for browser requests. Allowed origins are configured in your tracking settings ([Settings -> Website Tracking](https://app.outlit.ai/workspace-profile/tracking) -> Enabled Domains).
