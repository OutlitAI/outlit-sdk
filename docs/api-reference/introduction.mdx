...
[Platform Actions](/ai-integrations/platform-actions) expose selected agent, automation, signal, destination, and workspace setting configuration through REST routes that are also available from the CLI and MCP.
...
<Card title="/api/agents, /api/automations, /api/signals, /api/destinations, and /api/settings" icon="sliders" href="/ai-integrations/platform-actions">
