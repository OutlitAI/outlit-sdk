...
| `outlit_list_integrations` through `outlit_get_integration_status` | Inspect integrations, start safe browser handoffs, and read preferred canonical readiness |
