...
The package also exports `customerToolContracts`, `defaultAgentToolNames`, `allCustomerToolNames`, and enum lists such as `customerSourceTypes` for schema-driven agent integrations.
