...
| `outlit_list_integrations` through `outlit_setup_integration` | Inspect integrations, negotiate and perform bounded setup, and read canonical configuration readiness |
