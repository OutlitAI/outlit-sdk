...
export default defineCommand({
  meta: {
    ...
    description: [
      ...
      "  features  -- get event and metered Feature usage for a customer",
      "  credits   -- get imported credit pools and burn summaries",
  ...
  subCommands: {
    ...
    credits: () => import("./credits").then((m) => m.default),
