...
const COMMANDS: readonly CmdDef[] = [
  ...
  {
    name: "activation",
    desc: "Configure company activation",
    subs: [
      {
        name: "get",
        desc: "Read the company activation definition",
        flags: [...COMMON],
      },
      {
        name: "preview",
        desc: "Preview historical company activation matches",
        flags: [
          ...COMMON,
          { name: "--signal", desc: "One customer-grain signal UUID" },
          { name: "--signals", desc: "Comma-separated customer-grain signal UUIDs" },
