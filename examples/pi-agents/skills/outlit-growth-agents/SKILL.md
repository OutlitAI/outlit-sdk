...
- deterministic pretriage matches from `outlit_activation_pretriage`, including no users in Core-derived activated or engaged stages, stale user activity, or no recent product activity
