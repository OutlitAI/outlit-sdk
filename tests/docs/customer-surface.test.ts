...
describe("customer-surface documentation", () => {
  ...
  test("keeps Pi collaboration policy and public export docs aligned", () => {
    ...
    expect(piReadme).toContain("including customer ownership and access")
    expect(piReadme).not.toContain("responsibility-only commands")
